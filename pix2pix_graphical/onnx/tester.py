...
def test_model(model_path: str) -> None:
    ...
    image_path = Path('E:/ML/test_data/pix2pix/output/facades_v1/examples/epoch1_1_A_real.png')
...
if __name__ == "__main__":
    test_model('E:/ML/test_data/pix2pix/output/facades_v1/epoch200.onnx')