...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.log_output_frozen_header.setFont(font3)
        ...
        sizePolicy5.setHeightForWidth(self.output_log.sizePolicy().hasHeightForWidth())
        self.output_log.setSizePolicy(sizePolicy5)
        ...
        sizePolicy8.setHeightForWidth(self.epoch_progress.sizePolicy().hasHeightForWidth())
        self.epoch_progress.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.train_progress.sizePolicy().hasHeightForWidth())
        self.train_progress.setSizePolicy(sizePolicy8)
        ...
        self.verticalLayout_4.setContentsMargins(4, 4, 4, 1)
        ...
        self.settings_dock_main_icon.setFont(font2)
        ...
        sizePolicy10.setHeightForWidth(self.experiment_settings_btn.sizePolicy().hasHeightForWidth())
        self.experiment_settings_btn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.experiment_settings_label.sizePolicy().hasHeightForWidth())
        self.experiment_settings_label.setSizePolicy(sizePolicy11)
        font6 = QFont()
        font6.setPointSize(16)
        self.experiment_settings_label.setFont(font6)
        ...
        sizePolicy10.setHeightForWidth(self.dataset_settings_btn.sizePolicy().hasHeightForWidth())
        self.dataset_settings_btn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.dataset_settings_label.sizePolicy().hasHeightForWidth())
        self.dataset_settings_label.setSizePolicy(sizePolicy11)
        self.dataset_settings_label.setFont(font6)
        ...
        sizePolicy10.setHeightForWidth(self.training_settings_btn.sizePolicy().hasHeightForWidth())
        self.training_settings_btn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.training_settings_label.sizePolicy().hasHeightForWidth())
        self.training_settings_label.setSizePolicy(sizePolicy11)
        self.training_settings_label.setFont(font6)
        ...
        sizePolicy10.setHeightForWidth(self.testing_settings_btn.sizePolicy().hasHeightForWidth())
        self.testing_settings_btn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.testing_settings_label.sizePolicy().hasHeightForWidth())
        self.testing_settings_label.setSizePolicy(sizePolicy11)
        self.testing_settings_label.setFont(font6)
        ...
        sizePolicy10.setHeightForWidth(self.utils_settings_btn.sizePolicy().hasHeightForWidth())
        self.utils_settings_btn.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.utils_settings_label.sizePolicy().hasHeightForWidth())
        self.utils_settings_label.setSizePolicy(sizePolicy11)
        self.utils_settings_label.setFont(font6)
        ...
        self.creator_tag = QLabel(self.settings_btns_frame)
        ...
        self.creator_tag.setFont(font4)
        self.creator_tag.setAlignment(Qt.AlignCenter)

        self.verticalLayout_4.addWidget(self.creator_tag)


        self.horizontalLayout_5.addWidget(self.settings_btns_frame)
        ...
        self.settings_section_header.setFont(font7)
        ...
        self.experiment_settings_container.setGeometry(QRect(0, 0, 331, 823))
        ...
        sizePolicy8.setHeightForWidth(self.load_size.sizePolicy().hasHeightForWidth())
        self.load_size.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.crop_size.sizePolicy().hasHeightForWidth())
        self.crop_size.setSizePolicy(sizePolicy8)
        ...
        sizePolicy12.setHeightForWidth(self.input_nc.sizePolicy().hasHeightForWidth())
        self.input_nc.setSizePolicy(sizePolicy12)
        ...
        sizePolicy13.setHeightForWidth(self.tabWidget_2.sizePolicy().hasHeightForWidth())
        self.tabWidget_2.setSizePolicy(sizePolicy13)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.utility_dock.setWindowTitle(QCoreApplication.translate("MainWindow", u"\u2191 Performance Monitor / Output Log", None))
        ...
        self.utils_settings_label.setText(QCoreApplication.translate("MainWindow", u"Utils           ", None))
        self.creator_tag.setText(QCoreApplication.translate("MainWindow", u"NectarGAN by Zachary Bork", None))
