...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_21 = QHBoxLayout(self.frame_50)
        self.horizontalLayout_21.setObjectName(u"horizontalLayout_21")
        self.horizontalLayout_21.setContentsMargins(0, 0, 0, 0)
        self.horizontalSpacer_13 = QSpacerItem(1015, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_21.addItem(self.horizontalSpacer_13)

        self.open_context_settings = QPushButton(self.frame_50)
        self.open_context_settings.setObjectName(u"open_context_settings")
        font1 = QFont()
        font1.setPointSize(7)
        self.open_context_settings.setFont(font1)

        self.horizontalLayout_21.addWidget(self.open_context_settings)
        ...
        self.frame_51 = QFrame(self.frame_17)
        ...
        self.graph_G_GAN = QCheckBox(self.frame_51)
        self.graph_G_GAN.setObjectName(u"graph_G_GAN")
        self.graph_G_GAN.setChecked(True)

        self.horizontalLayout_30.addWidget(self.graph_G_GAN)

        self.graph_G_L1 = QCheckBox(self.frame_51)
        self.graph_G_L1.setObjectName(u"graph_G_L1")
        self.graph_G_L1.setChecked(True)

        self.horizontalLayout_30.addWidget(self.graph_G_L1)

        self.graph_G_SOBEL = QCheckBox(self.frame_51)
        self.graph_G_SOBEL.setObjectName(u"graph_G_SOBEL")
        self.graph_G_SOBEL.setChecked(True)

        self.horizontalLayout_30.addWidget(self.graph_G_SOBEL)

        self.graph_G_LAP = QCheckBox(self.frame_51)
        self.graph_G_LAP.setObjectName(u"graph_G_LAP")
        self.graph_G_LAP.setChecked(True)

        self.horizontalLayout_30.addWidget(self.graph_G_LAP)

        self.graph_G_VGG = QCheckBox(self.frame_51)
        self.graph_G_VGG.setObjectName(u"graph_G_VGG")
        self.graph_G_VGG.setChecked(True)

        self.horizontalLayout_30.addWidget(self.graph_G_VGG)
        ...
        self.graph_D_real = QCheckBox(self.frame_52)
        self.graph_D_real.setObjectName(u"graph_D_real")
        self.graph_D_real.setChecked(True)

        self.horizontalLayout_51.addWidget(self.graph_D_real)

        self.graph_D_fake = QCheckBox(self.frame_52)
        self.graph_D_fake.setObjectName(u"graph_D_fake")
        self.graph_D_fake.setChecked(True)

        self.horizontalLayout_51.addWidget(self.graph_D_fake)

        self.horizontalSpacer_15 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_51.addItem(self.horizontalSpacer_15)


        self.verticalLayout_39.addWidget(self.frame_52)
        ...
        sizePolicy4.setHeightForWidth(self.dockWidgetContents_2.sizePolicy().hasHeightForWidth())
        self.dockWidgetContents_2.setSizePolicy(sizePolicy4)
        ...
        sizePolicy1.setHeightForWidth(self.output_log_group.sizePolicy().hasHeightForWidth())
        self.output_log_group.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.output_log.sizePolicy().hasHeightForWidth())
        self.output_log.setSizePolicy(sizePolicy6)
        ...
        sizePolicy8.setHeightForWidth(self.frame_28.sizePolicy().hasHeightForWidth())
        self.frame_28.setSizePolicy(sizePolicy8)
        ...
        sizePolicy9.setHeightForWidth(self.train_progress.sizePolicy().hasHeightForWidth())
        self.train_progress.setSizePolicy(sizePolicy9)
        ...
        sizePolicy4.setHeightForWidth(self.settings_dock_main_icon.sizePolicy().hasHeightForWidth())
        self.settings_dock_main_icon.setSizePolicy(sizePolicy4)
        self.settings_dock_main_icon.setMinimumSize(QSize(50, 50))
        self.settings_dock_main_icon.setMaximumSize(QSize(100, 100))
        self.settings_dock_main_icon.setFont(font4)
        ...
        sizePolicy11.setHeightForWidth(self.experiment_settings_btn.sizePolicy().hasHeightForWidth())
        self.experiment_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.experiment_settings_label.sizePolicy().hasHeightForWidth())
        self.experiment_settings_label.setSizePolicy(sizePolicy12)
        font7 = QFont()
        ...
        sizePolicy11.setHeightForWidth(self.dataset_settings_btn.sizePolicy().hasHeightForWidth())
        self.dataset_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.dataset_settings_label.sizePolicy().hasHeightForWidth())
        self.dataset_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy11.setHeightForWidth(self.training_settings_btn.sizePolicy().hasHeightForWidth())
        self.training_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.training_settings_label.sizePolicy().hasHeightForWidth())
        self.training_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy11.setHeightForWidth(self.testing_settings_btn.sizePolicy().hasHeightForWidth())
        self.testing_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.testing_settings_label.sizePolicy().hasHeightForWidth())
        self.testing_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy11.setHeightForWidth(self.review_settings_btn.sizePolicy().hasHeightForWidth())
        self.review_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.review_settings_label.sizePolicy().hasHeightForWidth())
        self.review_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy11.setHeightForWidth(self.utils_settings_btn.sizePolicy().hasHeightForWidth())
        self.utils_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.utils_settings_label.sizePolicy().hasHeightForWidth())
        self.utils_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy11.setHeightForWidth(self.settings_settings_btn.sizePolicy().hasHeightForWidth())
        self.settings_settings_btn.setSizePolicy(sizePolicy11)
        ...
        sizePolicy12.setHeightForWidth(self.settings_settings_label.sizePolicy().hasHeightForWidth())
        self.settings_settings_label.setSizePolicy(sizePolicy12)
        ...
        sizePolicy9.setHeightForWidth(self.load_size.sizePolicy().hasHeightForWidth())
        self.load_size.setSizePolicy(sizePolicy9)
        ...
        sizePolicy9.setHeightForWidth(self.crop_size.sizePolicy().hasHeightForWidth())
        self.crop_size.setSizePolicy(sizePolicy9)
        ...
        sizePolicy13.setHeightForWidth(self.input_nc.sizePolicy().hasHeightForWidth())
        self.input_nc.setSizePolicy(sizePolicy13)
        ...
        sizePolicy14.setHeightForWidth(self.tabWidget_2.sizePolicy().hasHeightForWidth())
        self.tabWidget_2.setSizePolicy(sizePolicy14)
        ...
        self.label_67 = QLabel(self.scrollAreaWidgetContents_10)
        ...
        self.context_settings_dock = QDockWidget(MainWindow)
        self.context_settings_dock.setObjectName(u"context_settings_dock")
        sizePolicy15 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Preferred)
        sizePolicy15.setHorizontalStretch(0)
        sizePolicy15.setVerticalStretch(0)
        sizePolicy15.setHeightForWidth(self.context_settings_dock.sizePolicy().hasHeightForWidth())
        self.context_settings_dock.setSizePolicy(sizePolicy15)
        self.context_settings_dock.setFeatures(QDockWidget.NoDockWidgetFeatures)
        self.context_settings_dock.setAllowedAreas(Qt.RightDockWidgetArea)
        ...
        self.verticalLayout_41 = QVBoxLayout(self.dockWidgetContents)
        self.verticalLayout_41.setObjectName(u"verticalLayout_41")
        self.verticalLayout_41.setContentsMargins(0, 0, 0, 0)
        self.scrollArea_9 = QScrollArea(self.dockWidgetContents)
        self.scrollArea_9.setObjectName(u"scrollArea_9")
        self.scrollArea_9.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 331, 734))
        self.verticalLayout_42 = QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout_42.setObjectName(u"verticalLayout_42")
        self.reload_stylesheet = QPushButton(self.scrollAreaWidgetContents)
        ...
        self.context_settings_dock.setWidget(self.dockWidgetContents)
        MainWindow.addDockWidget(Qt.DockWidgetArea.RightDockWidgetArea, self.context_settings_dock)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.open_context_settings.setText(QCoreApplication.translate("MainWindow", u"Show Visualizer Settings", None))
        ...
        self.graph_G_GAN.setText(QCoreApplication.translate("MainWindow", u"G_GAN", None))
        self.graph_G_L1.setText(QCoreApplication.translate("MainWindow", u"G_L1", None))
        self.graph_G_SOBEL.setText(QCoreApplication.translate("MainWindow", u"G_SOBEL", None))
        self.graph_G_LAP.setText(QCoreApplication.translate("MainWindow", u"G_LAPLACIAN", None))
        self.graph_G_VGG.setText(QCoreApplication.translate("MainWindow", u"G_VGG", None))
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"Disciminator Loss", None))
        self.graph_D_real.setText(QCoreApplication.translate("MainWindow", u"D_real", None))
        self.graph_D_fake.setText(QCoreApplication.translate("MainWindow", u"D_fake", None))
        ...
        self.label_67.setText(QCoreApplication.translate("MainWindow", u"Settings", None))
        ...
        self.context_settings_dock.setWindowTitle(QCoreApplication.translate("MainWindow", u"Training Display Settings", None))
