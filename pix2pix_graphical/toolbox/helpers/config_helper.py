...
class ConfigHelper:
    ...
    def _build_mappings(self) -> None:
        ...
        self.CONFIG_MAP = {
            ...
            'gen_features': ('train.generator.features', 'QSpinBox'),
            'gen_n_downs': ('train.generator.n_downs', 'QSpinBox'),
            'gen_block_type': ('train.generator.block_type', 'QComboBox'),
            'gen_upsample_type': ('train.generator.upsample_type', 'QComboBox'),

            # Discriminator Architecture
            'n_layers_d': ('train.discriminator.n_layers', 'QSpinBox'), 
            'base_channels_d': ('train.discriminator.base_channels', 'QSpinBox'),
            'max_channels_d': ('train.discriminator.max_channels', 'QSpinBox'),
