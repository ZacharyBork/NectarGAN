...
## Sobel Loss
Reference: [`nectargan.losses.losses.Sobel`](https://github.com/ZacharyBork/NectarGAN/blob/main/nectargan/losses/losses.py#L5)
...
![\_sobel_heatmap_example_](../../resources/images/sobel_heatmap_example.png)
...
## Laplacian Loss
Reference: [`nectargan.losses.losses.Laplacian`](https://github.com/ZacharyBork/NectarGAN/blob/main/nectargan/losses/losses.py#L53)
...
![\_laplacian_heatmap_example_](../../resources/images/laplacian_heatmap_example.png)
...
## VGGPerceptual
Reference: [`nectargan.losses.losses.VGGPerceptual`](https://github.com/ZacharyBork/NectarGAN/blob/main/nectargan/losses/losses.py#L94)
> [!IMPORTANT]
